...
| **Filtering**           | Filters live in the page's toolbar above the table ([Page Layouts](#page-layouts)), never as inline per-column filter inputs embedded in the header row — that pattern doesn't scale to the table's responsive/mobile behavior below.                                                                                                           |
